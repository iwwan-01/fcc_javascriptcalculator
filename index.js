  ...
  return (
    <div className='container'>
      <div className='grid'>
        ...
        <div onClick={() => display('9')} className='padButton nine' id='nine'>
          9
        </div>
        <div
          onClick={() => display('-')}
        ...
        <div onClick={() => display('4')} className='padButton four' id='four'>
          4
        </div>
        <div onClick={() => display('5')} className='padButton five' id='five'>
          5
        </div>
        ...
        <div onClick={calculate} className='padButton equal' id='equals'>
          =
        </div>
        <div onClick={() => display('0')} className='padButton zero' id='zero'>
          0
        </div>
        <div
          onClick={() => display('.')}
